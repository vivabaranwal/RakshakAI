...
export default function Contact() {
    return (
        <div className="min-h-[100svh] bg-latte-bg dot-grid text-latte-text pt-24 sm:pt-32 pb-12 px-5 sm:px-6 font-sans flex flex-col items-center">
            ...
            >
                <h1 className="font-serif text-3xl sm:text-5xl md:text-6xl font-medium uppercase tracking-[0.12em] sm:tracking-widest text-latte-ink mb-5 sm:mb-6">
                    Get in Touch
                </h1>

                <div className="w-20 sm:w-24 h-[1.5px] bg-latte-ink mx-auto mb-5 sm:mb-6" />

                <p className="font-serif text-base sm:text-xl italic text-latte-subtext max-w-lg mx-auto leading-relaxed">
            ...
            <motion.div
                ...
                className="w-full max-w-md bg-latte-surface border-2 border-latte-ink rounded-none p-6 sm:p-8 animate-fadeIn"
            >
                <h2 className="font-serif text-2xl sm:text-4xl font-medium uppercase tracking-wide text-latte-ink mb-2">Viva Baranwal</h2>
                ...
                <div className="space-y-6">
                    ...
                    >
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="break-all font-sans text-sm font-medium">baranwalviva@gmail.com</p>
                        </div>
                    </a>
